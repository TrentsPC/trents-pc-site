...
const WHITE_POINT_D65 = [95.047, 100.0, 108.883] as const;
...
export function xyzFromArgb(argb: number): number[] {
  ...
  return mathUtils.matrixMultiply([r, g, b], SRGB_TO_XYZ as mathUtils.Matrix3);
}
...
export function lstarFromArgb(argb: number): number {
  const y = xyzFromArgb(argb)[1] as number;
